...
export function DeliveryCarAnimation({
  ...
  useEffect(() => {
    ...
    if (mode === 'return') {
      ...
      // 2. Realizes mistake & screeches in REVERSE with tire smoke, brake dive, & scenery streaming backward
      const t1 = setTimeout(() => setPhase('reverse_screech'), 700)
  ...
  return (
    <div className="w-full relative overflow-hidden select-none my-2 font-mono">
      ...
      <style dangerouslySetInnerHTML={{
        ...
        /* Comic Line Sequential Reveal */
        @keyframes comicLineIn {
          0% { transform: translateX(-6px); opacity: 0; }
          100% { transform: translateX(0); opacity: 1; }
        }
        .anim-line-in {
          animation: comicLineIn 0.28s cubic-bezier(0.16, 1, 0.3, 1) forwards;
        }
          ...
          >
            ...
            >
              ...
              >
                ...
                {/* ========================================================================= */}
                {/* === LUXURY SUPERCAR CABIN INTERIOR === */}
                {/* ========================================================================= */}
                ...
                <g transform="translate(236, 66)">
                  ...
                  {/* 4 Quilted Leather Cushions with Neon-Yellow Twin Stitching */}
                ...
                {/* ========================================================================= */}
                {/* === AUTHENTIC JOHNNY BRAVO CHARACTER (Steps out, drops crate, speaks) === */}
                {/* ========================================================================= */}
        ...
        {mode === 'return' && (phase === 'drop_parcel' || phase === 'hop_in' || phase === 'car_leaving' || phase === 'delivered_idle') && (
          ...
          >
            ...
            >
              ...
              {/* PARCEL CRATE BODY (Completely static and firmly planted on the tarmac) */}
              ...
              {/* CRATE LID: Pops off only when unboxed */}
              <g
