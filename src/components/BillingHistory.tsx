      ...
      <html>
        <head>
          ...
          <style>
            ...
            .made-in { font-size: 20px; font-weight: 900; font-style: italic; }
        ...
        <body>
          ...
          <div class="footer">
            <div class="made-in">MADE IN <span style="color: #ff9933;">BHA</span><span style="color: #000;">R</span><span style="color: #128807;">AT</span></div>
            <div class="help-box">
