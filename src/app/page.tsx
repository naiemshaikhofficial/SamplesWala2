...
export const metadata = generatePageMetadata({
  ...
  description: "Samples Wala is the ultimate royalty-free sample library for Indian and global loops, one-shots, and presets. Trusted by producers at T-Series, Sony Music, and Zee Music. The perfect Splice alternative for modern music creators.",
  path: '/'
})
...
export default async function HomePage() {
  ...
  const organizationSchema = {
    ...
    "sameAs": [
      ...
      "https://scamadviser.com/is-sampleswala.com-legit",
      "https://www.trustpilot.com/review/sampleswala.com"
    ],
    "description": "Samples Wala is the ultimate royalty-free music sample library. Access millions of premium Indian and global loops, one-shots, and presets. Trusted by producers at T-Series, Sony Music, and Zee Music. The perfect alternative to Splice.com.",
    "review": [
      {
        "@type": "Review",
        "author": {
