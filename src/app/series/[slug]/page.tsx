  ...
  return (
    <div className="w-full min-h-screen flex flex-col">
      ...
      <div className="container mx-auto px-4 pb-16 flex-1">
        ...
        <div className="relative p-8 md:p-16 border-4 border-black bg-black/70 backdrop-blur-sm shadow-[8px_8px_0px_rgba(255,200,0,1)] rounded-sm overflow-hidden mb-16 select-none jagged-border">
